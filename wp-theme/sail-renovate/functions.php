...
function sail_register_acf_fields() {
	...
	acf_add_local_field_group( [
		...
		'fields' => [
			...
			[ 'key' => 'field_home_hero_video',          'label' => 'Hero Video File (MP4)',         'name' => 'home_hero_video',            'type' => 'file',    'return_format' => 'url', 'mime_types' => 'mp4',       'instructions' => 'Upload an MP4. Leave blank to use the default theme video.' ],
			[ 'key' => 'field_home_hero_video_webm',     'label' => 'Hero Video File (WebM)',        'name' => 'home_hero_video_webm',       'type' => 'file',    'return_format' => 'url', 'mime_types' => 'webm',      'instructions' => 'Optional WebM version for better browser compatibility. The browser will use this in preference to the MP4 if supported.' ],
			[ 'key' => 'field_home_hero_poster',         'label' => 'Hero Video Poster Image',       'name' => 'home_hero_poster',           'type' => 'image',   'return_format' => 'url', 'preview_size' => 'thumbnail', 'instructions' => 'Shown before the video loads. Leave blank to use the default.' ],
			[ 'key' => 'field_home_hero_badge_text',     'label' => 'Hero Badge Text',               'name' => 'home_hero_badge_text',       'type' => 'text',    'default_value' => 'We make your home feel extraordinary again.', 'instructions' => 'Floating badge in the hero image column.' ],
			[ 'key' => 'field_home_hero_badge_location', 'label' => 'Hero Badge Location Line',      'name' => 'home_hero_badge_location',   'type' => 'text',    'default_value' => 'Bristol & Surrounding Areas' ],
			[ 'key' => 'field_home_services_link_label', 'label' => 'Services — "All Services" Label', 'name' => 'home_services_link_label', 'type' => 'text',   'default_value' => 'All Services' ],
			[ 'key' => 'field_home_services_link_url',   'label' => 'Services — "All Services" URL',   'name' => 'home_services_link_url',   'type' => 'url',    'default_value' => '/services/' ],
			[ 'key' => 'field_home_why_image',           'label' => 'Why Us — Section Image',        'name' => 'home_why_image',             'type' => 'image',   'return_format' => 'id', 'preview_size' => 'medium', 'instructions' => 'Photo displayed in the Why Us section. Leave blank to use the default theme image.' ],
			[ 'key' => 'field_home_why_image_alt',       'label' => 'Why Us — Image Alt Text',       'name' => 'home_why_image_alt',         'type' => 'text',    'instructions' => 'Leave blank to use the media library alt text.' ],
			[ 'key' => 'field_home_portfolio_link_label','label' => 'Portfolio — "View all" Label',  'name' => 'home_portfolio_link_label',  'type' => 'text',    'default_value' => 'View all projects' ],
			[ 'key' => 'field_home_portfolio_link_url',  'label' => 'Portfolio — "View all" URL',    'name' => 'home_portfolio_link_url',    'type' => 'url',     'default_value' => '/projects/' ],
			// Intro Band
			...
			[ 'key' => 'field_home_cta_title',        'label' => 'CTA Panel Title',        'name' => 'home_cta_title',        'type' => 'text', 'default_value' => 'Ready to start your' ],
			[ 'key' => 'field_home_cta_title_accent', 'label' => 'CTA Panel Title Accent', 'name' => 'home_cta_title_accent', 'type' => 'text', 'instructions' => 'This word renders in italic orange.', 'default_value' => 'project?' ],
