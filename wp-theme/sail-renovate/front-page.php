...
<section class="contact" id="contact" aria-labelledby="contact-heading">
  <div class="contact__info">
    ...
    <div class="contact__detail">
      ...
      <div>
        <span class="contact__detail-label"><?php esc_html_e( 'Phone', 'sail-renovate' ); ?></span>
        <a href="<?php echo esc_attr( $phone_tel ); ?>" class="contact__detail-value"><?php echo esc_html( $phone ); ?></a>
      </div>
    </div>
    ...
    <div class="contact__detail">
      ...
      <div>
        <span class="contact__detail-label"><?php esc_html_e( 'Email', 'sail-renovate' ); ?></span>
        <a href="mailto:<?php echo esc_attr( sail_contact( 'email' ) ); ?>" class="contact__detail-value"><?php echo esc_html( sail_contact( 'email' ) ); ?></a>
      </div>
    </div>
    ...
    <div class="contact__detail">
      ...
      <div>
        <span class="contact__detail-label"><?php esc_html_e( 'Location', 'sail-renovate' ); ?></span>
        <span class="contact__detail-value"><?php echo esc_html( sail_contact( 'location' ) ); ?></span>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="contact__socials">
        <a href="<?php echo esc_url( sail_contact( 'instagram_url' ) ); ?>" class="social-btn" aria-label="<?php esc_attr_e( 'Instagram', 'sail-renovate' ); ?>" rel="noopener noreferrer" target="_blank">
        ...
        <a href="<?php echo esc_url( sail_contact( 'facebook_url' ) ); ?>" class="social-btn" aria-label="<?php esc_attr_e( 'Facebook', 'sail-renovate' ); ?>" rel="noopener noreferrer" target="_blank">
