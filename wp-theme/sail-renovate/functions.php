...
function sail_register_acf_fields() {
	...
	acf_add_local_field_group( [
		...
		'fields' => [
			...
			[ 'key' => 'field_home_cta_title', 'label' => 'CTA Panel Title', 'name' => 'home_cta_title', 'type' => 'text', 'instructions' => 'Wrap italic/orange words in <em>…</em>.', 'default_value' => 'Ready to start your <em>project?</em>' ],
