...
function sail_register_acf_fields() {
	...
	acf_add_local_field_group( [
		...
		'fields' => [
			...
			[ 'key' => 'field_home_hero_video',          'label' => 'Hero Video File',               'name' => 'home_hero_video',            'type' => 'file',    'return_format' => 'url', 'mime_types' => 'mp4,webm', 'instructions' => 'Upload an MP4 or WebM. Leave blank to use the default theme video.' ],
